...
!choose by random haplotypes from a multinomial
integer ndim,i
...
!calculate haplotypic frequebcies from p1, p2 and d
...
! calcula allelis frequencies and d from frecs(4)
real*8 frecs(4), p1, p2, d
! frecs (1) is for AB
! frecs (2) is for Ab
! frecs (3) is for aB
